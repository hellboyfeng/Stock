    ...
    DateRangePicker.prototype = {
        ...
        setOptions: function(options, callback) {
            ...
            if (this.singleDatePicker) {
                ...
                this.container.find('http://webapplayers.com/inspinia_admin-v2.3/js/plugins/daterangepicker/.calendar.left').hide();
                if (!this.timePicker) {
        ...
        updateCalendars: function () {
            ...
            this.container.find('http://webapplayers.com/inspinia_admin-v2.3/js/plugins/daterangepicker/.calendar.left').empty().html(this.renderCalendar(this.leftCalendar.calendar, this.startDate, this.minDate, this.maxDate, 'left'));
